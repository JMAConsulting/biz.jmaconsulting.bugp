 ...
 *
 */
class CRM_Grant_Selector extends CRM_Core_Selector_Base implements CRM_Core_Selector_API {
  ...
  static $_properties = array(
    'contact_id', 'application_received_date', 'decision_date',
    'money_transfer_date', 'grant_due_date',
    'grant_report_received', 'grant_type_id', 'amount_total',
    'amount_requested', 'amount_granted', 'currency',
    'rationale', 'status_id', 'financial_type_id',
  );
