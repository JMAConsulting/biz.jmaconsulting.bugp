...
";
  ...
  static function buildProfile(
    ...
    elseif (in_array($fieldName, array(
      'membership_start_date', 'membership_end_date', 'join_date', 'application_received_date', 'decision_date', 'grant_money_transfer_date', 'grant_due_date'))) {
...
";
  ...
  static function updateGroupTypes($gId, $groupTypes = array(
    ...
    $componentGroupTypes = array('Contribution', 'Participant', 'Membership', 'Activity', 'Case', 'Grant');
